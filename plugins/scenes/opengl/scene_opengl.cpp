...
// scene2
//****************************************
bool scene2::supported(render::gl::backend* backend)
{
...
QMatrix4x4 scene2::createProjectionMatrix() const
{
...
void scene2::updateProjectionMatrix()
{
