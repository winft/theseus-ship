    ...
    : KCModule(parent, data)
{
    ...
    cycleAction->setText(i18nc("@action Overview and Grid View are the name of KWin effects",
    ...
    QAction* reverseCycleAction
        = actionCollection->addAction(QStringLiteral("Cycle Overview Opposite"));
