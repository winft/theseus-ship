    ...
    , m_shutdownTimer(new QTimer(this))
{
    ...
    connect(m_overviewState,
            &EffectTogglableState::inProgressChanged,
            this,
            &OverviewEffect::overviewGestureInProgressChanged);
    connect(m_overviewState,
            &EffectTogglableState::partialActivationFactorChanged,
            this,
            &OverviewEffect::overviewPartialActivationFactorChanged);
    ...
    connect(m_overviewState,
            ...
            [this](EffectTogglableState::Status status) {
                ...
                if (status == EffectTogglableState::Status::Inactive
                    || status == EffectTogglableState::Status::Deactivating) {
                    m_transitionState->stop();
                }
                if (status == EffectTogglableState::Status::Inactive) {
    ...
    connect(m_transitionState,
            &EffectTogglableState::inProgressChanged,
            this,
            &OverviewEffect::transitionGestureInProgressChanged);
    connect(m_transitionState,
            &EffectTogglableState::partialActivationFactorChanged,
            this,
            &OverviewEffect::transitionPartialActivationFactorChanged);

    connect(m_gridState,
            &EffectTogglableState::inProgressChanged,
            this,
            &OverviewEffect::gridGestureInProgressChanged);
    connect(m_gridState,
            &EffectTogglableState::partialActivationFactorChanged,
            this,
            &OverviewEffect::gridPartialActivationFactorChanged);
    ...
    cycleAction->setText(i18nc("@action Grid View and Overview are the name of KWin effects",
    ...
    reverseCycleAction->setText(i18nc("@action Grid View and Overview are the name of KWin effects",
    ...
    overviewAction->setText(
        i18nc("@action Overview is the name of a Kwin effect", "Toggle Overview"));
    ...
    gridAction->setText(
        i18nc("@action Grid view is the name of a Kwin effect", "Toggle Grid View"));
