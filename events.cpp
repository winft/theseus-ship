...
void Workspace::registerEventFilter(platform::x11::event_filter* filter)
{
...
takeEventFilter(platform::x11::event_filter* eventFilter,
...
void Workspace::unregisterEventFilter(platform::x11::event_filter* filter)
{
