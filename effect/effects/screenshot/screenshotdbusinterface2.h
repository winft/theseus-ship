...
public Q_SLOTS:
    QVariantMap
    CaptureWindow(const QString& handle, const QVariantMap& options, QDBusUnixFileDescriptor pipe);
    QVariantMap CaptureActiveWindow(const QVariantMap& options, QDBusUnixFileDescriptor pipe);
    QVariantMap CaptureArea(int x,
                            int y,
                            int width,
                            int height,
    ...
    QVariantMap
    CaptureScreen(const QString& name, const QVariantMap& options, QDBusUnixFileDescriptor pipe);
