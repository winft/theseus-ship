                                      ...
                                      xcb_window_t leaderWid = XCB_WINDOW_NONE)
{
    ...
    xcb_change_property(conn,                                            // c
                        ...
                        wid,                                             // window
                        Test::app()->workspace->atoms->wm_client_leader, // property
...
void StackingOrderTest::testTransientIsAboveParent()
{
    ...
    QCOMPARE(Test::app()->workspace->stacking_order->sorted(), (std::deque<Toplevel*>{parent}));
    ...
    QCOMPARE(Test::app()->workspace->stacking_order->sorted(),
...
void StackingOrderTest::testGroupTransientIsAboveWindowGroup()
{
    ...
    QCOMPARE(Test::app()->workspace->stacking_order->sorted(), (std::deque<Toplevel*>{leader}));
...
void StackingOrderTest::testKeepAbove()
{
    ...
    QCOMPARE(Test::app()->workspace->stacking_order->sorted(), (std::deque<Toplevel*>{clientA}));
    ...
    {
        blocker block(Test::app()->workspace->stacking_order);
