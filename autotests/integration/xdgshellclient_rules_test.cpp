...
void TestXdgShellClientRules::testPositionDontAffect()
{
    ...
    group.writeEntry("positionrule", int(win::rules::ruling::DontAffect));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testPositionApply()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("position", QPoint(42, 42));
    group.writeEntry("positionrule", int(win::rules::ruling::Apply));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testPositionRemember()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("position", QPoint(42, 42));
    group.writeEntry("positionrule", int(win::rules::ruling::Remember));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testPositionForce()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("position", QPoint(42, 42));
    group.writeEntry("positionrule", int(win::rules::ruling::Force));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testPositionApplyNow()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("position", QPoint(42, 42));
    group.writeEntry("positionrule", int(win::rules::ruling::ApplyNow));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testPositionForceTemporarily()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("position", QPoint(42, 42));
    group.writeEntry("positionrule", int(win::rules::ruling::ForceTemporarily));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSizeDontAffect()
{
    ...
    group.writeEntry("sizerule", int(win::rules::ruling::DontAffect));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSizeApply()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("size", QSize(480, 640));
    group.writeEntry("sizerule", int(win::rules::ruling::Apply));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSizeRemember()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("size", QSize(480, 640));
    group.writeEntry("sizerule", int(win::rules::ruling::Remember));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSizeForce()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("size", QSize(480, 640));
    group.writeEntry("sizerule", int(win::rules::ruling::Force));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSizeApplyNow()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("size", QSize(480, 640));
    group.writeEntry("sizerule", int(win::rules::ruling::ApplyNow));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSizeForceTemporarily()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("size", QSize(480, 640));
    group.writeEntry("sizerule", int(win::rules::ruling::ForceTemporarily));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testMaximizeDontAffect()
{
    ...
    group.writeEntry("maximizehorizrule", int(win::rules::ruling::DontAffect));
    group.writeEntry("maximizevert", true);
    group.writeEntry("maximizevertrule", int(win::rules::ruling::DontAffect));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testMaximizeApply()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("maximizehoriz", true);
    group.writeEntry("maximizehorizrule", int(win::rules::ruling::Apply));
    group.writeEntry("maximizevert", true);
    group.writeEntry("maximizevertrule", int(win::rules::ruling::Apply));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testMaximizeRemember()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("maximizehoriz", true);
    group.writeEntry("maximizehorizrule", int(win::rules::ruling::Remember));
    group.writeEntry("maximizevert", true);
    group.writeEntry("maximizevertrule", int(win::rules::ruling::Remember));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testMaximizeForce()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("maximizehoriz", true);
    group.writeEntry("maximizehorizrule", int(win::rules::ruling::Force));
    group.writeEntry("maximizevert", true);
    group.writeEntry("maximizevertrule", int(win::rules::ruling::Force));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testMaximizeApplyNow()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("maximizehoriz", true);
    group.writeEntry("maximizehorizrule", int(win::rules::ruling::ApplyNow));
    group.writeEntry("maximizevert", true);
    group.writeEntry("maximizevertrule", int(win::rules::ruling::ApplyNow));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testMaximizeForceTemporarily()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("maximizehoriz", true);
    group.writeEntry("maximizehorizrule", int(win::rules::ruling::ForceTemporarily));
    group.writeEntry("maximizevert", true);
    group.writeEntry("maximizevertrule", int(win::rules::ruling::ForceTemporarily));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testDesktopDontAffect()
{
    ...
    group.writeEntry("desktoprule", int(win::rules::ruling::DontAffect));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testDesktopApply()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("desktop", 2);
    group.writeEntry("desktoprule", int(win::rules::ruling::Apply));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testDesktopRemember()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("desktop", 2);
    group.writeEntry("desktoprule", int(win::rules::ruling::Remember));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testDesktopForce()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("desktop", 2);
    group.writeEntry("desktoprule", int(win::rules::ruling::Force));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testDesktopApplyNow()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("desktop", 2);
    group.writeEntry("desktoprule", int(win::rules::ruling::ApplyNow));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testDesktopForceTemporarily()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("desktop", 2);
    group.writeEntry("desktoprule", int(win::rules::ruling::ForceTemporarily));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testMinimizeDontAffect()
{
    ...
    group.writeEntry("minimizerule", int(win::rules::ruling::DontAffect));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testMinimizeApply()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("minimize", true);
    group.writeEntry("minimizerule", int(win::rules::ruling::Apply));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testMinimizeRemember()
{
    ...
    group.writeEntry("minimizerule", int(win::rules::ruling::Remember));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testMinimizeForce()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("minimize", false);
    group.writeEntry("minimizerule", int(win::rules::ruling::Force));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testMinimizeApplyNow()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("minimize", true);
    group.writeEntry("minimizerule", int(win::rules::ruling::ApplyNow));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testMinimizeForceTemporarily()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("minimize", false);
    group.writeEntry("minimizerule", int(win::rules::ruling::ForceTemporarily));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipTaskbarDontAffect()
{
    ...
    group.writeEntry("skiptaskbarrule", int(win::rules::ruling::DontAffect));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipTaskbarApply()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skiptaskbar", true);
    group.writeEntry("skiptaskbarrule", int(win::rules::ruling::Apply));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipTaskbarRemember()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skiptaskbar", true);
    group.writeEntry("skiptaskbarrule", int(win::rules::ruling::Remember));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipTaskbarForce()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skiptaskbar", true);
    group.writeEntry("skiptaskbarrule", int(win::rules::ruling::Force));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipTaskbarApplyNow()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skiptaskbar", true);
    group.writeEntry("skiptaskbarrule", int(win::rules::ruling::ApplyNow));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipTaskbarForceTemporarily()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skiptaskbar", true);
    group.writeEntry("skiptaskbarrule", int(win::rules::ruling::ForceTemporarily));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipPagerDontAffect()
{
    ...
    group.writeEntry("skippagerrule", int(win::rules::ruling::DontAffect));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipPagerApply()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skippager", true);
    group.writeEntry("skippagerrule", int(win::rules::ruling::Apply));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipPagerRemember()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skippager", true);
    group.writeEntry("skippagerrule", int(win::rules::ruling::Remember));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipPagerForce()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skippager", true);
    group.writeEntry("skippagerrule", int(win::rules::ruling::Force));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipPagerApplyNow()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skippager", true);
    group.writeEntry("skippagerrule", int(win::rules::ruling::ApplyNow));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipPagerForceTemporarily()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skippager", true);
    group.writeEntry("skippagerrule", int(win::rules::ruling::ForceTemporarily));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipSwitcherDontAffect()
{
    ...
    group.writeEntry("skipswitcherrule", int(win::rules::ruling::DontAffect));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipSwitcherApply()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skipswitcher", true);
    group.writeEntry("skipswitcherrule", int(win::rules::ruling::Apply));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipSwitcherRemember()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skipswitcher", true);
    group.writeEntry("skipswitcherrule", int(win::rules::ruling::Remember));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipSwitcherForce()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skipswitcher", true);
    group.writeEntry("skipswitcherrule", int(win::rules::ruling::Force));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipSwitcherApplyNow()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skipswitcher", true);
    group.writeEntry("skipswitcherrule", int(win::rules::ruling::ApplyNow));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testSkipSwitcherForceTemporarily()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("skipswitcher", true);
    group.writeEntry("skipswitcherrule", int(win::rules::ruling::ForceTemporarily));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testKeepAboveDontAffect()
{
    ...
    group.writeEntry("aboverule", int(win::rules::ruling::DontAffect));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testKeepAboveApply()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("above", true);
    group.writeEntry("aboverule", int(win::rules::ruling::Apply));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testKeepAboveRemember()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("above", true);
    group.writeEntry("aboverule", int(win::rules::ruling::Remember));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testKeepAboveForce()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("above", true);
    group.writeEntry("aboverule", int(win::rules::ruling::Force));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testKeepAboveApplyNow()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("above", true);
    group.writeEntry("aboverule", int(win::rules::ruling::ApplyNow));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testKeepAboveForceTemporarily()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("above", true);
    group.writeEntry("aboverule", int(win::rules::ruling::ForceTemporarily));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testKeepBelowDontAffect()
{
    ...
    group.writeEntry("belowrule", int(win::rules::ruling::DontAffect));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testKeepBelowApply()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("below", true);
    group.writeEntry("belowrule", int(win::rules::ruling::Apply));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testKeepBelowRemember()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("below", true);
    group.writeEntry("belowrule", int(win::rules::ruling::Remember));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testKeepBelowForce()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("below", true);
    group.writeEntry("belowrule", int(win::rules::ruling::Force));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testKeepBelowApplyNow()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("below", true);
    group.writeEntry("belowrule", int(win::rules::ruling::ApplyNow));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testKeepBelowForceTemporarily()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("below", true);
    group.writeEntry("belowrule", int(win::rules::ruling::ForceTemporarily));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testShortcutDontAffect()
{
    ...
    group.writeEntry("shortcutrule", int(win::rules::ruling::DontAffect));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testShortcutApply()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("shortcut", "Ctrl+Alt+1");
    group.writeEntry("shortcutrule", int(win::rules::ruling::Apply));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testShortcutRemember()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("shortcut", "Ctrl+Alt+1");
    group.writeEntry("shortcutrule", int(win::rules::ruling::Remember));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testShortcutForce()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("shortcut", "Ctrl+Alt+1");
    group.writeEntry("shortcutrule", int(win::rules::ruling::Force));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testShortcutApplyNow()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("shortcut", "Ctrl+Alt+1");
    group.writeEntry("shortcutrule", int(win::rules::ruling::ApplyNow));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testShortcutForceTemporarily()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("shortcut", "Ctrl+Alt+1");
    group.writeEntry("shortcutrule", int(win::rules::ruling::ForceTemporarily));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testActiveOpacityDontAffect()
{
    ...
    group.writeEntry("opacityactiverule", int(win::rules::ruling::DontAffect));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testActiveOpacityForce()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("opacityactive", 90);
    group.writeEntry("opacityactiverule", int(win::rules::ruling::Force));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testActiveOpacityForceTemporarily()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("opacityactive", 90);
    group.writeEntry("opacityactiverule", int(win::rules::ruling::ForceTemporarily));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testInactiveOpacityDontAffect()
{
    ...
    group.writeEntry("opacityinactiverule", int(win::rules::ruling::DontAffect));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testInactiveOpacityForce()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("opacityinactive", 80);
    group.writeEntry("opacityinactiverule", int(win::rules::ruling::Force));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
...
void TestXdgShellClientRules::testInactiveOpacityForceTemporarily()
{
    ...
    KConfigGroup group = config->group("1");
    group.writeEntry("opacityinactive", 80);
    group.writeEntry("opacityinactiverule", int(win::rules::ruling::ForceTemporarily));
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", int(win::rules::ruling::ExactMatch));
    group.sync();
