...
void TestScriptedEffectLoader::testKnownEffects()
{
    ...
    expectedEffects << QStringLiteral("kwin4_effect_dialogparent")
                    ...
                    << QStringLiteral("kwin4_effect_login") << QStringLiteral("kwin4_effect_logout")
...
void TestScriptedEffectLoader::testLoadScriptedEffect_data()
{
    ...
    QTest::newRow("EyeOnScreen-Force")
        << QStringLiteral("kwin4_effect_eyeonscreen") << true << forceFlags;
    ...
    QTest::newRow("EyeOnScreen-DontLoad")
        << QStringLiteral("kwin4_effect_eyeonscreen") << false << dontLoadFlags;
}
...
void TestScriptedEffectLoader::testLoadScriptedEffect()
{
    ...
    const auto services = KPackage::PackageLoader::self()->findPackages(
