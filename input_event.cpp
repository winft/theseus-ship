...
MouseEvent::MouseEvent(QEvent::Type type, const QPointF &pos, Qt::MouseButton button,
                       ...
                       quint64 timestampMicroseconds, input::pointer* device)
...
SwitchEvent::SwitchEvent(State state, quint32 timestamp, quint64 timestampMicroseconds, input::switch_device* device)
